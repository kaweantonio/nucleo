...
/* 	Teste 1.1 - Status 0 (Fracasso - processo não existe) 
...
/* 	Teste 1.2 - Status 0 (Fracasso - processo existe mas está terminado) 
...
/* 	Teste 2 - Status 1 (Fracasso - fila de mensagens cheia) 
